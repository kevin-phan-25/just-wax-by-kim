 ...
 *
 * Updates:
 * • Hardcoded top offset (inline styles — resists CSS overrides)
 * • Matched Gallery clearance under fixed navbar
...
export default function Policies() {
  return (
    <section
      ...
      "
      style={{
        // Hardcoded clearance under fixed navbar
        // mobile ~110px nav, md ~140px, xl ~168px + breathing room
        paddingTop: "200px",
      }}
    >
      {/* Ambient Background */}
      ...
      <div
        ...
        "
        style={{
          // Extra safety if a parent collapses section padding
          marginTop: 0,
          paddingTop: 0,
        }}
      >
        ...
        >
          {POLICIES_DATA.map((section, index) => (
            <div
              key={section.id}
              className={index % 2 === 0 ? "col-start-2" : "col-start-4"}
            >
