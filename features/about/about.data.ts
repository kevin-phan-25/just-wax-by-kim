...
export const aboutContent: AboutSection = {
  ...
  description: [
    ...
    `At Just Wax by Kim, I believe every person is unique. That’s why I take the time to understand your skin, your concerns, and your goals so every service is customized with you in mind. I’m committed to creating a welcoming, judgment-free environment. I proudly provide a safe, respectful, and inclusive space where people of all genders, body types, skin tones, and backgrounds can feel completely at ease. Whether it’s your first wax or you’re a seasoned pro, I want every appointment to leave you feeling comfortable, cared for, and confident.`,
